...
timeout 899 python3 ~/.claude/skills/open-claude-gpt/scripts/cdp_consult.py wait --rid <request_id> --conversation <conversation_id> --out /tmp/cgc_answer_<request_id>.txt --timeout 870
...
timeout 899 python3 ~/.claude/skills/open-claude-gpt/scripts/cdp_consult.py wait --out /tmp/cgc_answer_<rid1>.txt --rid <rid1> --timeout 870
...
timeout 899 python3 ~/.claude/skills/open-claude-gpt/scripts/cdp_consult.py followup \
