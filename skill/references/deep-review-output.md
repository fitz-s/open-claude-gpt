...
say why it dominates. This is the highest-value section — challenge the premise.
...
Cover every changed file — do not stop early. One finding per line, ONE severity scale throughout:
