...
| `references/gpt-5.5-prompting-principles.md` | OpenAI's official GPT-5.5 prompt guidance distilled — the outcome-first structure the live `PROMPT_TEMPLATE` follows |
| `README.md` | This file |
